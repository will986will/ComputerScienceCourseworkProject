...
{
    // tiledata for tiles
    // this data is used for saving and for loading maps which is why anything that the game can figure out isn't saved
        ...
        public void Draw(GameTime gameTime_, SpriteBatch spriteBatch_)
        {
            ...
            if (Object.TypeId != 0)
            {
                ...
                if (Object.TypeId.Equals(2)
                    ...
                    && !(Object.ObjectId.Equals(Building.CoalPlant().ObjectId)))
                {
