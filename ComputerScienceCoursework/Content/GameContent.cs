...
namespace ComputerScienceCoursework.Content
{
    ...
    public class GameContent
    {
        ...
        public void LoadUITextures()
        {
            ...
            UiTextures.Add(new ContentData<Texture2D>(i++, "Sprites/UI/Icons/Icon_Money", _content));
            ...
            UiTextures.Add(new ContentData<Texture2D>(i++, "Sprites/UI/Icons/Icon_Cell_House_High_Rise", _content)); // 40
            UiTextures.Add(new ContentData<Texture2D>(i++, "Sprites/UI/Icons/Icon_Cell_Coal_Power_Plant", _content)); // 41

            Console.WriteLine($"Ui Textures: {i}"); //testing line to check if the correct amount of textures were loaded
        }
        ...
        public void LoadTileTextures()
        {
            ...
            TileTextures.Add(new ContentData<Texture2D>(i++, "Sprites/Tiles/Buildings/House/10", _content)); // 39
            TileTextures.Add(new ContentData<Texture2D>(i++, "Sprites/Tiles/Buildings/House/11", _content)); // 40
            TileTextures.Add(new ContentData<Texture2D>(i++, "Sprites/Tiles/Buildings/House/12", _content)); // 41
            TileTextures.Add(new ContentData<Texture2D>(i++, "Sprites/Tiles/Buildings/Power/03", _content)); // 42
